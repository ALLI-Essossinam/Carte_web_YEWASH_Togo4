...
map.getView().fit([124255.482740, 817350.605437, 186163.767365, 851040.646069], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">CARTE WEB PROJET YEWASH-PLAN TOGO INTER</h2>';
        return titleElement;
    })(),
